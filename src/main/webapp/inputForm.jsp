  ...
  <body>
    ...
    <div class="wrap">
      ...
      <form action="/signup.member" method="post">
        ...
        />
        <p id="result"></p>
        <button type="button" id="DupleCheck" onclick="emailDupleCheck()">중복확인</button>
    ...
    <script>
      ...
      $("#emailCheck").click(function () {
        window.open("emailCheck.jsp", "이메일인증", "width=700px,height=700px");
      });
  		...
  		$.ajax({
  			...
  			success : function(res){
  				...
  				if(res == "true") {
  					...
  					$("#result").html("사용가능한 ID입니다. ").css("color","white");
  				}			
  			},
  			error : function(){
  				alert("요청실패") 
